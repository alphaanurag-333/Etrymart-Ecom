...
/** Model: discountType percentage | flat; percentage discount is 0–100. */
function assertProductDiscountMatchesType(discountType, discountValue) {
...
exports.createProduct = asyncHandler(async (req, res) => {
  ...
  assertProductDiscountMatchesType(discountType, discountValue);
  ...
  const product = await Product.create({
    ...
    addedById,
    status,
    ...(Object.prototype.hasOwnProperty.call(req.body, "adminApproved") && {
      adminApproved: coerceBoolean(req.body.adminApproved, "adminApproved"),
    }),
  });
...
exports.updateProduct = asyncHandler(async (req, res) => {
  ...
  if (Object.prototype.hasOwnProperty.call(req.body, "adminApproved")) {
    product.adminApproved = coerceBoolean(req.body.adminApproved, "adminApproved");
  }

  assertProductDiscountMatchesType(product.discountType, product.discountValue);
